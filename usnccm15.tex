...
\begin{center}
\includegraphics[width=0.5\textwidth]{ibanez_cse15-3.png}
\end{center}
}
...
\begin{center}
\includegraphics[width=0.5\textwidth]{ibanez_cse15-4.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.5\textwidth]{ibanez_cse15-6.png}
\end{center}
...
\frame{\frametitle{Parallel Mesh Remotes}
...
\frame{\frametitle{Remote Arrays}
...
\end{center}
A separate array maps vertices to their
first remote.
}
